function loading() {
  $(function () {
    $(window).bind("load resize", function () {
      ...
      (i -= e),
        1 > i && (i = 1),
        i > e && $("#page-wrapper").css("min-height", i + "px");
    });
    for (
  ...
  $("#fullscreen-searchform").css("top", e / 2),
  ...
  $(".material-ripple").on("click", function (e) {
    var n = $(this);
    0 === n.find(".material-ink").length &&
      n.prepend("<div class='material-ink'></div>");
...
function performanceChart(element, data, categoryField) {
  ...
  var chart = AmCharts.makeChart(element, {
    ...
    graphs: [
      {
        ...
        lineAlpha: 0,
        alphaField: "alpha",
        balloonText: "[[category]]: [[value]] lần",
        dashLengthField: "dashLength",
        fillAlphas: 0.7,
        // "legendPeriodValueText": "total: [[value.sum]]",
        legendValueText: "([[category]]: [[value]] lần)",
        title: "Hiệu suất sử dụng",
        type: "column",
        valueField: "count",
    ...
    legend: {
      ...
      valueAlign: "left",
      equalWidths: false,
      periodValueText: "(Tổng cộng: [[value.sum]]) lần"
    },
    chartCursor: {
      cursorAlpha: 0,
