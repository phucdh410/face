      ...
      return (
        ...
        this.each(function () {
              ...
              "height" in i &&
                ...
                ("auto" == i.height
                  ? (E.parent().css("height", "auto"),
                    E.css("height", "auto"),
                    (o.height = E.parent().parent().height()))
                  : (o.height = i.height)),
              E.parent().css({
                position: "relative",
                overflow: "hidden",
          ...
          if (!(t.isPlainObject(i) && "destroy" in i)) {
            ...
            var F = t(T).addClass(o.wrapperClass).css({
              position: "relative",
              overflow: "hidden",
              width: o.width,
              height: o.height
...
function slimScrollInitiallize(
  element,
  height,
  equalOther,
  other,
  ...
  if (equalOther && other) {
    var h = $(other).height();
    if (h > tolerance) height = h - tolerance;
  }
